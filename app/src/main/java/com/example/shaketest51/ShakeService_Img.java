...
public class ShakeService_Img extends Service implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(mAccel > 11){
            ...
            ImgChangeActivity.change_ImageView.setImageResource(resIds[img_index]);
